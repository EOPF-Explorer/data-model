...
- **[Architecture](architecture.md)** - Technical architecture and design principles
  - **[STAC Integration and Zarr URL Resolution](architecture.md#stac-integration-and-zarr-url-resolution)** - How to open Zarr assets from STAC hrefs, and the role of the `rel: store` link
